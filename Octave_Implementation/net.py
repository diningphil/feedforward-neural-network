...
# fileptr = open("monks2prep.train","r")
# dataset = []
# testset = []
# for line in fileptr:
#     linevec = line.split()
#     dataset.append(Instance(map(float, linevec[1:]), map(float, [linevec[0]])))
#     testset.append(Instance(map(float, linevec[1:])))
...
#         ERROR_LIMIT          = 1e-10,
#         max_iterations       = 1000,   # Regardless of the achieved error, terminate after max_iterations epochs. Default: infinite
